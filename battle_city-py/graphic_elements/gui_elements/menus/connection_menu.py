...
class ConnectionMenu(UserElement):
    def __init__(self, rect: Rect, absolute_position: Tuple):
        ...
        self.join_button = Button(Rect(100, 300, 600, 100), (absolute_position[0], absolute_position[1]))
    ...
    def update(self, e: UserEvent, output_buffer: BufferToGameLogic):
        ...
        output_buffer.is_join_button_pressed_button_pressed = self.join_button.is_clicked
