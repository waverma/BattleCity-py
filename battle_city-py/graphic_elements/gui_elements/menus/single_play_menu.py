...
class SinglePlayMenu(UserElement):
    def __init__(self, rect: Rect, absolute_position: Tuple):
        ...
        self.new_game_button = Button(Rect(100, 100, 600, 100), (absolute_position[0], absolute_position[1]))
        ...
        self.exit_button = Button(Rect(100, 300, 600, 100), (absolute_position[0], absolute_position[1]))
    ...
    def update(self, e: UserEvent, output_buffer: BufferToGameLogic):
        ...
        output_buffer.is_new_game_button_pressed = self.new_game_button.is_clicked
