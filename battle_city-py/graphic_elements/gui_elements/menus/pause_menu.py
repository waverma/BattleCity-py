...
class PauseMenu(UserElement):
    def __init__(self, rect: Rect, absolute_position: Tuple):
        ...
        self.continue_button = Button(Rect(100, 100, 600, 100), (absolute_position[0], absolute_position[1]))
        self.continue_button.draw_info.fill_color = (255, 255, 0)
        self.continue_button.focused_outline_color = (255, 0, 0)
        self.continue_button.draw_info.outline_size = 3
        self.continue_button.draw_info.text = "Продолжить"
    ...
    def update(self, e: UserEvent, output_buffer: BufferToGameLogic):
        ...
        output_buffer.is_return_button_pressed = (e.pressed_buttons[pygame.K_ESCAPE]
                                                  and len(e.non_released_buttons) > 0
                                                  and not e.non_released_buttons[pygame.K_ESCAPE]
                                                  ) or self.continue_button.is_clicked
        output_buffer.is_to_main_menu_button_pressed = self.exit_button.is_clicked
