...
class TextureImageInfo:
    def __init__(self, file_name: str):
        ...
        self.images[(1, 1)] = pygame.image.load(os.path.join(os.path.dirname(
            os.path.abspath(__file__)), "Textures", file_name)
        )
        self.textures["main"] = [self.images[(1, 1)].get_rect().x,
