...
def get_map() -> GameField:
    ...
    field.try_place_unit(
        BreakableWall(BIG_WALL_LENGTH * 3, BIG_WALL_LENGTH),
    ...
    field.try_place_unit(
        BreakableWall(BIG_WALL_LENGTH, BIG_WALL_LENGTH + LITTLE_WALL_LENGTH),
        BIG_WALL_LENGTH * 4, BIG_WALL_LENGTH + LITTLE_WALL_LENGTH
    )

    field.try_place_unit(
        BreakableWall(BIG_WALL_LENGTH, BIG_WALL_LENGTH),
        BIG_WALL_LENGTH * 9, BIG_WALL_LENGTH
    )

    field.try_place_unit(
        BreakableWall(BIG_WALL_LENGTH, BIG_WALL_LENGTH),
        BIG_WALL_LENGTH * 6, BIG_WALL_LENGTH + LITTLE_WALL_LENGTH
    )

    field.try_place_unit(
        BreakableWall(BIG_WALL_LENGTH, BIG_WALL_LENGTH * 4),
        BIG_WALL_LENGTH * 11, BIG_WALL_LENGTH * 2
    )

    field.try_place_unit(
        BreakableWall(BIG_WALL_LENGTH, BIG_WALL_LENGTH),
        BIG_WALL_LENGTH * 12, BIG_WALL_LENGTH * 2
    )

    field.try_place_unit(
        BreakableWall(BIG_WALL_LENGTH, BIG_WALL_LENGTH),
        BIG_WALL_LENGTH * 10, BIG_WALL_LENGTH * 5
    )

    field.try_place_unit(
        BreakableWall(BIG_WALL_LENGTH, BIG_WALL_LENGTH * 2),
        BIG_WALL_LENGTH * 7, BIG_WALL_LENGTH * 3
    )

    field.try_place_unit(
        BreakableWall(LITTLE_WALL_LENGTH, BIG_WALL_LENGTH),
        BIG_WALL_LENGTH * 8, BIG_WALL_LENGTH * 3
    )
    ...
    field.try_place_unit(
        BreakableWall(BIG_WALL_LENGTH * 3, BIG_WALL_LENGTH),
        BIG_WALL_LENGTH * 2, BIG_WALL_LENGTH * 5
    )

    field.try_place_unit(
        BreakableWall(BIG_WALL_LENGTH, BIG_WALL_LENGTH),
        0, BIG_WALL_LENGTH * 11
    )
    ...
    field.try_place_unit(
        BreakableWall(BIG_WALL_LENGTH * 2, BIG_WALL_LENGTH),
        BIG_WALL_LENGTH * 6, BIG_WALL_LENGTH * 7
    )

    field.try_place_unit(
        BreakableWall(BIG_WALL_LENGTH, BIG_WALL_LENGTH),
        BIG_WALL_LENGTH * 5, BIG_WALL_LENGTH * 8
    )

    field.try_place_unit(
        BreakableWall(BIG_WALL_LENGTH * 2, BIG_WALL_LENGTH),
        BIG_WALL_LENGTH * 9, BIG_WALL_LENGTH * 10
    )

    field.try_place_unit(
        BreakableWall(BIG_WALL_LENGTH, BIG_WALL_LENGTH),
        BIG_WALL_LENGTH * 9, BIG_WALL_LENGTH * 11
    )

    field.try_place_unit(
        BreakableWall(LITTLE_WALL_LENGTH, BIG_WALL_LENGTH),
        BIG_WALL_LENGTH * 12 + LITTLE_WALL_LENGTH, BIG_WALL_LENGTH * 10
    )

    field.try_place_unit(
        BreakableWall(BIG_WALL_LENGTH * 2, LITTLE_WALL_LENGTH),
        BIG_WALL_LENGTH * 12, BIG_WALL_LENGTH * 11
    )

    field.try_place_unit(
        UnbreakableWall(BIG_WALL_LENGTH * 3, LITTLE_WALL_LENGTH),
        BIG_WALL_LENGTH * 2, BIG_WALL_LENGTH * 4 + LITTLE_WALL_LENGTH
    )

    field.try_place_unit(
        UnbreakableWall(BIG_WALL_LENGTH, BIG_WALL_LENGTH),
        BIG_WALL_LENGTH * 4, BIG_WALL_LENGTH * 6
    )

    field.try_place_unit(
        UnbreakableWall(BIG_WALL_LENGTH * 2, LITTLE_WALL_LENGTH),
        BIG_WALL_LENGTH * 4, BIG_WALL_LENGTH * 10
    )

    field.try_place_unit(
        UnbreakableWall(BIG_WALL_LENGTH * 2, LITTLE_WALL_LENGTH),
        BIG_WALL_LENGTH * 6, BIG_WALL_LENGTH * 8
    )
    ...
    field.try_place_unit(
        UnbreakableWall(BIG_WALL_LENGTH, LITTLE_WALL_LENGTH),
        BIG_WALL_LENGTH * 10, BIG_WALL_LENGTH * 6
    )

    field.try_place_unit(
        UnbreakableWall(LITTLE_WALL_LENGTH + BIG_WALL_LENGTH, BIG_WALL_LENGTH),
        BIG_WALL_LENGTH * 9, BIG_WALL_LENGTH * 4
    )

    field.try_place_unit(
        Dirt(BIG_WALL_LENGTH * 5, BIG_WALL_LENGTH),
        BIG_WALL_LENGTH, BIG_WALL_LENGTH * 3
    )

    field.try_place_unit(
        Dirt(BIG_WALL_LENGTH, BIG_WALL_LENGTH * 4),
        BIG_WALL_LENGTH * 5, BIG_WALL_LENGTH * 4
    )

    field.try_place_unit(
        Dirt(BIG_WALL_LENGTH * 3, BIG_WALL_LENGTH),
        0, BIG_WALL_LENGTH * 7
    )

    field.try_place_unit(
        Dirt(BIG_WALL_LENGTH, BIG_WALL_LENGTH),
        BIG_WALL_LENGTH * 4, BIG_WALL_LENGTH * 7
    )

    field.try_place_unit(
        Dirt(BIG_WALL_LENGTH * 2, BIG_WALL_LENGTH),
        BIG_WALL_LENGTH * 6, BIG_WALL_LENGTH * 5
    )

    field.try_place_unit(
        Dirt(BIG_WALL_LENGTH, BIG_WALL_LENGTH * 4),
        BIG_WALL_LENGTH * 9, BIG_WALL_LENGTH * 5
    )

    field.try_place_unit(
        Dirt(BIG_WALL_LENGTH * 2, BIG_WALL_LENGTH),
        BIG_WALL_LENGTH * 10, BIG_WALL_LENGTH * 8
    )
    ...
    spawner.tanks_to_go.append(HealBot())
    spawner.tanks_to_go.append(ArmoredBot())
    field.try_place_unit(spawner, BIG_WALL_LENGTH * 12,
                         BIG_WALL_LENGTH * 8)
    field.spawners.append(spawner)
    ...
    field.try_place_unit(field.player, BIG_WALL_LENGTH * 6,
                         BIG_WALL_LENGTH * 12)
