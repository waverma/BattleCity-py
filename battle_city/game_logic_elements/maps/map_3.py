...
def get_map() -> GameField:
    ...
    field.try_place_unit(
        ...
        BIG_WALL_LENGTH * 4,
        BIG_WALL_LENGTH + LITTLE_WALL_LENGTH,
    )
    ...
    field.try_place_unit(
        BreakableWall(BIG_WALL_LENGTH, BIG_WALL_LENGTH), 0, BIG_WALL_LENGTH * 5
    )
    ...
    field.try_place_unit(
        BreakableWall(LITTLE_WALL_LENGTH, BIG_WALL_LENGTH),
        BIG_WALL_LENGTH * 12 + LITTLE_WALL_LENGTH,
        BIG_WALL_LENGTH * 10,
    )
    ...
    field.try_place_unit(
        Dirt(BIG_WALL_LENGTH * 3, BIG_WALL_LENGTH), 0, BIG_WALL_LENGTH * 7
    )
