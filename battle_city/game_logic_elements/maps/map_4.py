...
def get_map() -> GameField:
    ...
    spawner.tanks_to_go.append(RapidFireBot())
    spawner.tanks_to_go.append(RapidFireBot())
    field.try_place_unit(spawner, BIG_WALL_LENGTH, BIG_WALL_LENGTH * 7)
    field.spawners.append(spawner)
    ...
    spawner.tanks_to_go.append(RapidFireBot())
    spawner.tanks_to_go.append(RapidFireBot())
    field.try_place_unit(spawner, BIG_WALL_LENGTH * 11, BIG_WALL_LENGTH * 7)
    field.spawners.append(spawner)
